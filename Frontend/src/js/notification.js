...
const notificationData = JSON.parse(
  ...
  document.getElementById(
    "originalResume"
  ).src = `data:application/pdf;base64,${resume1Base64}`;
  document.getElementById(
    "updatedResume"
  ).src = `data:application/pdf;base64,${resume2Base64}`;
  ...
  function approveChanges() {
    apiClient
      .patch(
        `/api/confirm-update/${notificationData.id_candidate}/`,
  ...
  function discardChanges() {
    apiClient
      .patch(
        `/api/cancel-update/${notificationData.id_candidate}/`,
        { id: notificationData.id_notification },
        {
          withCredentials: true,
          headers: {
  ...
  function profile() {
    apiClient
      .get(
        `/api/get-candidate/${notificationData.id_candidate}/`,
        {
          withCredentials: true,
      }
      )
